...
def main():
    ...
    while True:
        ...
        faces = face_cascade.detectMultiScale(gray, scaleFactor=1.1, minNeighbors=6, minSize=(150,150), flags=cv2.CASCADE_SCALE_IMAGE)
        ...
        #---------------------------------- Speak Detection ----------------------------------#
        mouths = mouth_cascade.detectMultiScale(mask, scaleFactor=1.5, minNeighbors=18)

        # Draw rectangles around the detected smiles
        for (mx, my, mw, mh) in mouths:
            cv2.rectangle(image_new, (mx, my), (mx + mw, my + mh), (255, 0, 0), 2)
